...
namespace PathFinding 
{
    public class ComputeGraph : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            LevelGraph = GenerateGraph(temp, 10);
            SendGraphToGameManager();
        }
      ...
      /*  void OnDrawGizmos()
        ...
        private void SendGraphToGameManager() 
        {
            GameManager = GameObject.FindWithTag("GameManager");
            GameManager.GetComponent<GameManager>().Graph = LevelGraph;
            GameManager.GetComponent<GameManager>().SpawnNPC();
        }
